    ...
    <div className="mx-auto max-w-6xl px-4 py-10 md:px-6 md:py-14">
      <SectionWrapper className="grid items-start gap-8 lg:grid-cols-2">
        <div>
          ...
          <h1 className="mt-2 text-4xl text-cocoa-900 md:text-5xl">Bring A Minor to Your Event</h1>
          <p className="mt-4 text-cocoa-700">
            ...
            <a href="mailto:bookaminor@uconn.edu" aria-label="Send booking email" className="ml-1 font-semibold text-denim-900 underline decoration-denim-300">bookaminor@uconn.edu</a>.
          </p>
        </div>
        <ContactForm />
      </SectionWrapper>
