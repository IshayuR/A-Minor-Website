    ...
    <footer className="mt-20 border-t border-denim-100 bg-sky-100/80">
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 md:grid-cols-3 md:px-6">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-cocoa-900">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-cocoa-900">
            <li><a href="mailto:bookaminor@uconn.edu" aria-label="Send us an email to book" className="hover:text-denim-700">bookaminor@uconn.edu</a></li>
            <li><Link href="/contact" aria-label="Go to booking form" className="hover:text-denim-700">Book Us Form</Link></li>
